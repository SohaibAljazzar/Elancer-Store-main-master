          ...
          Padding(
            ...
            child: FadeInRight(
              child: GridView.builder(
                ...
                shrinkWrap: true,
                itemCount: appGet.home['data']['categories'].length,
                itemBuilder: (context, index) {
                  return buildAspectRatio(
                      appGet.home['data']['categories'][index]);
                },
              ),
            ),
          ),
  ...
  Widget buildAspectRatio(item) {
    return GestureDetector(
      onTap: () async {
        ...
        await controller.getSubCategory(item['id']);
        SVProgressHUD.dismiss();

        await Navigator.pushNamed(context, '/sub_category_screen');
      },
      child: Column(
        children: [
          SizedBox(
